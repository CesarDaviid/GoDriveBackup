...
func main() {
	...
	var argu string = os.Args[1]
	var argu2 string = os.Args[2]
	...
	dir, err := createDir(service, argu2, "root")

	if err != nil {
		panic(fmt.Sprintf("Could not create dir: %v\n", err))
	}

	file, err := createFile(service, argu, "application/x-7z-compressed", f, dir.Id)
